...
export default function MetaCreate({ auth, currentDatabase }) {
    ...
    const onSubmit = (e) => {
        e.preventDefault();
        const formattedAccountId = data.account_id.startsWith("act_")
            ? data.account_id
            : `act_${data.account_id}`;
            ...
            header={
                <div className="flex justify-between items-center">
                    <h2 className="font-semibold text-xl text-gray-800 dark:text-gray-200 leading-tight">
                        New Meta Account Creating
                    </h2>
                </div>
            }
        >
            <Head title={`New Meta Account Creating`} />
            <div className="py-12">
