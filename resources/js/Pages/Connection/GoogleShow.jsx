...
export default function GoogleShow({
    auth,
    currentDatabase,
    googleAccounts,
    success,
    ...
    const [googleAccountsList, setGoogleAccountsList] =
        useState(googleAccounts);

    const deleteGoogleAccount = (account_id) => {
        if (!window.confirm("Are you sure you want to delete this account?")) {
            return;
        }
        router.delete(
            route("google.destroy", {
